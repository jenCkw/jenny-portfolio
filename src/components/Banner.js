...
export const Banner = () => {
  ...
  const toRotate = [ "Web Developer", "Digital Marketer", "Team Leader" ];
  const period = 2000;
          ...
          <Col xs={12} md={6} xl={7}>
            <TrackVisibility>
              ...
              <div className={isVisible ? "animate__animated animate__fadeIn" : ""}>
                ...
                <h1>{`Hi! I'm Jenny`} <span className="txt-rotate" dataPeriod="1000" data-rotate='[ "Fullstack Web Developper", "Digital marketer/communication", "Team Leder" ]'><span className="wrap">{text}</span></span></h1>
